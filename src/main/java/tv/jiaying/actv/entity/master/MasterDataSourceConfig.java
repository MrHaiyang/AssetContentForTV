...
@Configuration
@ConfigurationProperties(prefix = "asset.master.datasource")
@EnableJpaRepositories(entityManagerFactoryRef = "masterEntityManagerFactory",
        transactionManagerRef = "masterTransactionManager", basePackages = "tv.jiaying.actv.entity.master")
public class MasterDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean masterEntityManagerFactory() {
        ...
        factoryBean.setPackagesToScan(MasterDataSourceConfig.class.getPackage().getName());
